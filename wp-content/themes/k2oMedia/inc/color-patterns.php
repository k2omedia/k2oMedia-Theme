...
.colors-custom.page:not(.k2oMedia-front-page) .entry-title,
...
.colors-custom .k2oMedia-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.k2oMedia-front-page .panel-content .recent-posts article,
...
.colors-custom.k2oMedia-front-page article:not(.has-post-thumbnail):not(:first-child),
