	...
	register_default_headers(
		array(
			'default-image' => array(
				...
				'description'   => __( 'Default Header Image', 'k2oMedia' ),
			),
		)
	);
}
...
function twentyseventeen_video_controls( $settings ) {
	$settings['l10n']['play']  = '<span class="screen-reader-text">' . __( 'Play background video', 'k2oMedia' ) . '</span>' . twentyseventeen_get_svg( array( 'icon' => 'play' ) );
	$settings['l10n']['pause'] = '<span class="screen-reader-text">' . __( 'Pause background video', 'k2oMedia' ) . '</span>' . twentyseventeen_get_svg( array( 'icon' => 'pause' ) );
	return $settings;
}
